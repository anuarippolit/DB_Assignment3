...
(4, 'max.verstappen@gmail.com', 'Max', 'Verstappen', 'Shymkent', '+77074444444', 'Tu-tu-tu-tu Max Verstappen', 'password123'),
(5, 'lewis.hamilton@nu.edu.kz', 'Lewis', 'Hamilton', 'Astana', '+77075555555', 'It is hammer time', 'password123'),
(6, 'zarina.nurmanova@mail.ru', 'Zarina', 'Nurmanova', 'Astana', '+77076666666', 'Experienced in both babysitting and elderly care', 'password123'),
(7, 'dilnaz.serikova@nu.edu.kz', 'Dilnaz', 'Serikova', 'Astana', '+77077777777', 'Professional elderly care specialist', 'password123'),
(8, 'aida.nurpeisova@gmail.com', 'Aida', 'Nurpeisova', 'Astana', '+77078888888', 'I am good caregiver', 'password123'),
(9, 'madina.alimova@mail.ru', 'Madina', 'Alimova', 'Astana', '+77079999999', 'Specialist in dementia care', 'password123'),
(10, 'ayana.zhaksybekova@nu.edu.kz', 'Ayana', 'Zhaksybekova', 'Astana', '+77071234567', 'Professional caregiver available weekends', 'password123'),
(11, 'arman.armanov@nu.edu.kz', 'Arman', 'Armanov', 'Astana', '+77079876543', 'Caregiver profile', 'password123'),
(12, 'ignat.ippolitovich@mail.ru', 'Ignat', 'Ippolitovich', 'Astana', '+77071112222', 'Father of two young cats', 'password123'),
(13, 'innokentiya.ippolitovich@gmail.com', 'Innokentiya', 'Ippolitovich', 'Almaty', '+77072223333', 'I am second cat child', 'password123'),
(14, 'kondratiya.ippolitovich@nu.edu.kz', 'Kondratiya', 'Ippolitovich', 'Astana', '+77073334444', 'I am third cat child', 'password123'),
(15, 'gulnara.gulimova@mail.ru', 'Gulnara', 'Gulimova', 'Astana', '+77074445555', 'Working mother needing weekend care', 'password123'),
(16, 'aigerim.nurlanova@gmail.com', 'Aigerim', 'Nurlanova', 'Almaty', '+77075556666', 'Daughter caring for aging parent', 'password123'),
(17, 'asel.mukhanova@nu.edu.kz', 'Asel', 'Mukhanova', 'Astana', '+77076667777', 'Mother of special needs child', 'password123'),
(18, 'carlos.sainz@mail.ru', 'Carlos', 'Sainz', 'Astana', '+77077778888', 'Smooth operator', 'password123'),
(19, 'roza.raimbaeva@gmail.com', 'Roza', 'Raimbaeva', 'Astana', '+77078889999', 'Grandmother watching grandchildren', 'password123'),
(20, 'george.russel@nu.edu.kz', 'George', 'Russel', 'Astana', '+77079991111', 'Cry me a river', 'password123'),
(21, 'valtteri.bottas@mail.ru', 'Valtteri', 'Bottas', 'Astana', '+77071239876', 'Box box box....do not mess my box', 'password123'),
(22, 'amina.aminova@gmail.com', 'Amina', 'Aminova', 'Almaty', '+77079871234', 'Member profile', 'password123');
...
(11, 'photo11.jpg', 'MALE', 'BABYSITTER', 3800);
